...
COMMON_STOPWORDS = {
    ...
    "기사","단독","속보","영상","전문","라이브","기자","보도","헤드라인","데스크","전체보기","더보기","사망","부상",
    "오늘","어제","금일","최근","방금","방금전","아침","오전","오후","밤","새벽","첫날",
    "관련","논란","논쟁","상황","사건","이슈","분석","전망","브리핑","발언","발표","입장",
    "서울","한국","국내","해외","정부","여당","야당","당국","위원장","장관","대통령","총리","국회","검찰","여성","남성","여자","남자",
    # 요청한 공용 블랙리스트(유튜브/트렌드 공통 적용)
    "구독","정치","대통령실","채널","news","대법원","특검","민주당","국민의힘","이잼","의원",
    # 방송사/매체 상수
    "sbs","kbs","mbc","jtbc","tv조선","mbn","연합뉴스","mbc뉴스","younhap","yonhapnews","knn",
    # 자주 뜨는 군더더기
    "시작","사고","전문","사진","동영상기사","동영상 기사","다큐멘터리","짧은","긴","중간"
}
