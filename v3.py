...
COMMON_STOPWORDS = {
    ...
    "구독","정치","대통령실","채널","news","대법원","특검","민주당","국민의힘","이잼","뉴스데스크",
    "sbs","kbs","mbc","jtbc","tv조선","mbn","연합뉴스","mbc뉴스","yonhapnews","yonhap","다큐멘터리","내 정보"
    "시작","사고","전문","사진","이제","최고","짧은","긴","최고","내정보","jong kim","뉴스","짧뉴","쇼츠","뉴스a","채널a","공식","kbc","00분","직접","라임저널"
}
...
STOPWORDS |= {
    ...
    "다큐디깅","나는","절로","석방하라","석방","전문","사고","news","대법원","특검","mbc뉴스","이잼","첫날","뉴스top10","내용"
}
STOPWORDS |= COMMON_STOPWORDS

KO_JOSA = ("듯","는","가","을","를","의","에","에서","에게","께","와","과","으로","로","도","만","까지","부터","마다","조차","라도","마저","밖에","처럼","뿐","께서","채","고")
KO_SUFFIX = ("하기","하세요","십시오","해주세요","합니다","했다","중","관련","영상","채널","뉴스","보기","등록","구독","홈페이지","됩니다","mbc","습니다","있습니다")
...
_POSTPOSITION_SUFFIXES = ("으로","로","에게","에서","보다","까지","부터","만","조차","라도","처럼","뿐","께","에","와","과","랑","하고","밖에","이라","라","이라도","는","가","채","만에","고","려","린","듯","채")
...
PHRASE_SIM_STOP = {
    ...
    "사실","상황","사건","문제","논란","논쟁","발언","입장","보도","당시","현장","추정","추락","폭행","체포","구속","떼 쓰려고","내정보","떼 써보려","내 정보","jong kim"
}
