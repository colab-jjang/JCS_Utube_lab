...
COMMON_STOPWORDS = {
    ...
    "시작","사고","전문","사진","이제","최고","짧은","긴","최고","내정보","jong kim","뉴스","짧뉴","쇼츠","뉴스a","채널a","공식","kbc","00분","직접"
}
...
_POSTPOSITION_SUFFIXES = ("으로","로","에게","에서","보다","까지","부터","만","조차","라도","처럼","뿐","께","에","와","과","랑","하고","밖에","이라","라","이라도","는","가","채","만에","고","려","린","한","듯","채")
