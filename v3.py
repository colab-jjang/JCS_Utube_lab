...
_POSTPOSITION_SUFFIXES = ("으로","로","에게","에서","보다","까지","부터","만","조차","라도","처럼","뿐","께","에","와","과","랑","하고","밖에","이라","라","이라도","은","는","이","가","채","만에","고")
...
PHRASE_SIM_STOP = {
    ...
    "사실","상황","사건","문제","논란","논쟁","발언","입장","보도","당시","현장","추정","추락","폭행","체포","구속","내 정보","떼 쓰려고","jong kim"
}
